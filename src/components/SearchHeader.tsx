      ...
      <div className="flex mx-auto max-w-4xl px-4 py-6 items-center sm:px-6 lg:px-8">
        ...
        <form className="flex w-2/5 items-center">   
          <div className="relative ml-4 w-full">
            <label htmlFor="simple-search" className="sr-only">Añadir palabra clave</label>
            ...
            <input type="text" id="simple-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Añadir palabra clave" required />
          </div>
