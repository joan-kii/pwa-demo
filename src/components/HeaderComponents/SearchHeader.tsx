  ...
  return (
    <div className="flex mx-auto px-4 pt-6 justify-between items-center sm:px-6 lg:px-8">
      ...
      <div className="flex w-1/2 items-center">
        <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" className="p-2 ms-2 text-sm font-medium text-white bg-gray-800 rounded-lg border border-gray-800 hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800" type="button">
          Realizar Búsqueda
        </button>
