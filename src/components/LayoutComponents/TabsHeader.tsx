  ...
  return (
    <div className="font-medium text-center">
      <ul className="flex flex-wrap justify-around text-gray-900">
        <li
          className={`flex items-center w-1/3 justify-center border-b-2 rounded-t-lg hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:cursor-pointer ${layout === 'recent' || layout === 'pending' ? 'border-gray-700' : 'border-white'}`}
        ...
        >
          ...
          <p className="inline-block p-4">Intervenciones</p>
        </li>
        <li
        ...
        >
          ...
          <p className="inline-block p-4">Nueva Intervención</p>
        </li>
        <li
        ...
        >
          ...
          <p className="inline-block p-4">Chats</p>
        </li>
      </ul>
    </div>
  )
