...
function InterventionKeywords(intervention: Intervention) {
  return (
    <div className="flex px-4 sm:pr-8 pb-2 sm:pb-5 justify-center sm:justify-end items-center">
      ...
      <p className="font-light text-sm sm:text-base text-slate-800">{intervention.keywords.join(' - ')}</p>
    </div>
  )
}
